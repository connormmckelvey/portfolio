...
var entry_worker_default = {
  async fetch(request, env, ctx) {
    ...
    if (request = new Request(request, { cf }), new URL(request.url).pathname === CorePaths.PLATFORM_PROXY)
    ...
    try {
      if (env[CoreBindings.SERVICE_LOCAL_EXPLORER]) {
        ...
        (preRewriteUrl.pathname === CorePaths.EXPLORER || preRewriteUrl.pathname.startsWith(`${CorePaths.EXPLORER}/`)) && validateLocalExplorerRequest(
          request,
